...
if __name__ == "__main__":
    ...
    cwd = os.getcwd()
    if os.path.isdir(os.path.join(cwd, "main")):
        shutil.rmtree(os.path.join(cwd, "main"))
    gh_md_to_html.main(
        md_origin=os.path.join(*os.path.split(cwd)[:-1], "README.md"),
        destination=os.path.join(".", "main"),
        css_paths=os.path.join(".", "main", "css"),
    )

    # Changes one line in the html file
    with open(os.path.join(cwd, "main", "README.html"), "r") as file:
        lines = file.readlines()
    lines[1] = '<link href="css/github-css.css" rel="stylesheet"/>\n'
    with open(os.path.join(cwd, "main", "README.html"), "w") as file:
        file.writelines(lines)

    # Changes the src of the images
    with open(os.path.join(cwd, "main", "README.html"), "r") as file:
        lines = file.readlines()
        for i, line in enumerate(lines):
            lines[i] = line.replace("/./main/images", "./images")
    with open(os.path.join(cwd, "main", "README.html"), "w") as file:
        file.writelines(lines)
