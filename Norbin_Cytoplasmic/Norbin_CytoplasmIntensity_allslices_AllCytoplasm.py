...
path=os.path.join(os.getcwd(),"Example_Data","*","*.lsm")
date='190416'
...
###################################################### 
with open(os.path.join(os.getcwd(),"Norbincumcurve","Example_Data", os.path.basename(imagei)+'CytoplasmMedianintensity_normalized.csv'), mode='w') as results_file:
