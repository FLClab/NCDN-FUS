...
input_dir=os.path.join(os.getcwd(),"Norbincumcurve","Example_Data","*.csv")
...
pyplot.savefig(os.path.join(os.getcwd(),"Norbincumcurve","Graphs",'Norbin median cytoplasmic intensity fold change_5dates_2std_noshNorb.pdf'),transparent=True)
boxplotdatafiltered={}
for key in labels:
    print(key)
...
fig.savefig(os.path.join(os.getcwd(),"Norbincumcurve","Graphs",'violinplot_medians_5dates_2std.pdf'),transparent=True)
pyplot.show()
