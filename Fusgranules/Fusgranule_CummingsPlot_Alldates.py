...
import scipy
import statsutils
input_dir=os.path.join(os.getcwd(),"Cumulative_FUS",'Example_Data',"*.npy")
os.makedirs(os.path.join(os.getcwd(),"Cumulative_FUS","graphs"),exist_ok=True)
...
for file in npylist:
    ...
    fig.savefig(os.path.join(os.getcwd(),"Cumulative_FUS","graphs",date+'fittedhistogram.pdf'),transparent=True)
    fig3.savefig(os.path.join(os.getcwd(),"Cumulative_FUS","graphs",date+'fittedhistogram_perimage.pdf'),transparent=True)
...
fig.savefig(os.path.join(os.getcwd(),"Cumulative_FUS","graphs",'violinplot.pdf'),transparent=True)
pyplot.show()
...
fig.savefig(os.path.join(os.getcwd(),"Cumulative_FUS","graphs",'boxplot.pdf'),transparent=True)
